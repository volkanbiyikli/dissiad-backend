...
@section('pagelink')
    <a href="{{route('new.index')}}" class="btn btn-danger kt-subheader__btn-options">Haberler</a>
@endsection
...
@section('breadcrumbs')
    ...
    <span class="kt-subheader__breadcrumbs-separator"></span>
    <span class="kt-subheader__breadcrumbs-link">Haber Düzenle</span>
@endsection
                ...
                <div class="kt-portlet kt-portlet--tab">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Haber Düzenle</h3>
                        </div>
                    </div>
                    <div class="kt-portlet__body">

                        <form action="{{route('new.update',$new->id)}}" method="post" enctype="multipart/form-data" class="kt-form" id="kt_form" novalidate="novalidate">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <h3 class="kt-section__title kt-section__title-lg">Haber Bilgileri</h3>
                                            @if($errors->any())
                                            ...
                                            <div class="form-group row">
                                                <label class="col-3 col-form-label">Haber Başlık *</label>
                                                <div class="col-9">
                                                    <input class="form-control" type="text" name="name" value="{{ ($new->name) }}">
                                                    <span class="form-text text-muted"></span>
                                                    <input class="form-control" type="hidden" name="old_name" value="{{ ($new->name) }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9 input-group date">
                                                    <input type="text" class="form-control" name="date" readonly="" value="{{\Carbon\Carbon::parse($new->date)->format('d.m.Y H:i')}}"
                                                           id="form_datetime">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" name="tag" value="{{ ($new->tag) }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div style="background-color: #f9f9f9; padding: 20px; border-radius: 3px" class="kt-valign-middle kt-align-center mb-3">
                                                        <img src="/upload/news/{{($new->image)}}" width="100%">
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-3 col-form-label">Haber Durumu</label>
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" value="1" {{$new->status ? 'checked' : ''}} name="status"><span></span></label>
							                        </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" value="1" {{$new->bigimage ? 'checked' : ''}} name="bigimage"><span></span></label>
							                        </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input class="form-control" type="url" name="url" value="{{ ($new->url) }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" {{$new->blank_url ? 'checked' : ''}} value="1" name="blank_url"><span></span></label>
							                        </span>
                                                </div>
                                            </div>

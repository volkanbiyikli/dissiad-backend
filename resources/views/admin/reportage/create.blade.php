...
@section('breadcrumbs')
    ...
    <span class="kt-subheader__breadcrumbs-separator"></span>
    <span class="kt-subheader__breadcrumbs-link">Röportaj Ekle</span>
@endsection
                ...
                <div class="kt-portlet kt-portlet--tab">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Röportaj Ekle</h3>
                        </div>
                    </div>
                    <div class="kt-portlet__body">

                        <form action="{{route('reportage.store')}}" method="post" enctype="multipart/form-data" class="kt-form" id="kt_form" novalidate="novalidate">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                        ...
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9 input-group date">
                                                    <input type="text" class="form-control" name="date" readonly="" value="{{ date('d.m.Y H:i', strtotime('3 hour')) }}"
                                                           id="form_datetime">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" value="1" name="bigimage"><span></span></label>
							                        </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="kt-align-right">
                                        <div class="kt-form__actions">
                                            <button type="submit" class="btn btn-primary">Röportaj Ekle</button>
                                        </div>
                                    </div>

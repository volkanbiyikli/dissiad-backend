...
@section('breadcrumbs')
    ...
    <a href="{{route('page.index')}}" class="kt-subheader__breadcrumbs-link">Sliderlar</a>
    <span class="kt-subheader__breadcrumbs-separator"></span>
    <span class="kt-subheader__breadcrumbs-link">Slider Düzenle</span>
@endsection
                ...
                <div class="kt-portlet kt-portlet--tab">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Slider Düzenle</h3>
                        </div>
                    </div>
                    <div class="kt-portlet__body">

                        <form action="{{route('slider.update',$slider->id)}}" method="post" enctype="multipart/form-data" class="kt-form" id="kt_form" novalidate="novalidate">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-xl-12">
                                        ...
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    ...
                                                    <input type="hidden" name="old_name" value="{{($slider->name)}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div style="background-color: #f9f9f9; padding: 20px; border-radius: 3px" class="kt-valign-middle kt-align-center mb-3">
                                                        @if ($slider->image)
                                                            <img src="/upload/sliders/{{($slider->image)}}" width="100%">
                                                        @endif
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" value="1" {{$slider->status ? 'checked' : ''}} name="status"><span></span></label>
							                        </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" {{$slider->blank_url ? 'checked' : ''}} value="1" name="blank_url"><span></span></label>
							                        </span>
                                                </div>
                                            </div>

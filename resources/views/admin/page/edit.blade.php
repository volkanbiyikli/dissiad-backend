...
@section('pagelink')
    <a href="{{route('page.index')}}" class="btn btn-danger kt-subheader__btn-options">Sayfalar</a>
@endsection
...
@section('breadcrumbs')
    ...
    <span class="kt-subheader__breadcrumbs-separator"></span>
    <span class="kt-subheader__breadcrumbs-link">Sayfa Düzenle</span>
@endsection
                ...
                <div class="kt-portlet kt-portlet--tab">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Sayfa Düzenle</h3>
                        </div>
                    </div>
                    <div class="kt-portlet__body">

                        <form action="{{route('page.update',$page->id)}}" method="post" enctype="multipart/form-data" class="kt-form" id="kt_form" novalidate="novalidate">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <h3 class="kt-section__title kt-section__title-lg">Sayfa Bilgileri</h3>
                                            @if($errors->any())
                                            ...
                                            <div class="form-group row">
                                                <label class="col-3 col-form-label">Sayfa Adı *</label>
                                                <div class="col-9">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <select name="category_id" class="form-control" id="exampleSelect1">
                                                        ...
                                                        <option value="dissiad" {{$page->category_id=="dissiad" ? 'selected' : ''}}>DİŞSİAD</option>
                                                        <option value="fuarlar" {{$page->category_id=="fuarlar" ? 'selected' : ''}}>FUARLAR</option>
                                                        <option value="yayinlar" {{$page->category_id=="yayinlar" ? 'selected' : ''}}>YAYINLAR</option>
                                                        <option value="bilgi-bankasi" {{$page->category_id=="bilgi-bankasi" ? 'selected' : ''}}>BİLGİ BANKASI</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div style="background-color: #f9f9f9; padding: 20px; border-radius: 3px" class="kt-valign-middle kt-align-center mb-3">
                                                        @if ($page->image)
                                                            <img src="/upload/pages/{{($page->image)}}" width="100%">
                                                        @endif
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-3 col-form-label">Sayfa Durumu</label>
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" value="1" {{$page->status ? 'checked' : ''}} name="status"><span></span></label>
							                        </span>
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-3 col-form-label">Üst Menü Gösterimi</label>
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" {{$page->menu_status ? 'checked' : ''}} value="1" name="menu_status"><span></span></label>
							                        </span>
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-3 col-form-label">Sol Menü Gösterimi</label>
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" {{$page->left_status ? 'checked' : ''}} value="1" name="left_status"><span></span></label>
							                        </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" {{$page->blank_url ? 'checked' : ''}} value="1" name="blank_url"><span></span></label>
							                        </span>
                                                </div>
                                            </div>

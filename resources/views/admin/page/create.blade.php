...
@section('breadcrumbs')
    ...
    <span class="kt-subheader__breadcrumbs-separator"></span>
    <span class="kt-subheader__breadcrumbs-link">Sayfa Ekle</span>
@endsection
                ...
                <div class="kt-portlet kt-portlet--tab">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Sayfa Ekle</h3>
                        </div>
                    </div>
                    <div class="kt-portlet__body">

                        <form action="{{route('page.store')}}" method="post" enctype="multipart/form-data" class="kt-form" id="kt_form" novalidate="novalidate">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <select name="category_id" class="form-control" id="exampleSelect1">
                                                        ...
                                                        <option value="dissiad">DİŞSİAD</option>
                                                        <option value="fuarlar">FUARLAR</option>
                                                        <option value="yayinlar">YAYINLAR</option>
                                                        <option value="bilgi-bankasi">BİLGİ BANKASI</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" checked="checked" value="1" name="menu_status"><span></span></label>
							                        </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--icon">
								                        <label><input type="checkbox" checked="checked" value="1" name="left_menu"><span></span></label>
							                        </span>
                                                </div>
                                            </div>

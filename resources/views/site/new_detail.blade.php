                                            ...
                                            @if ($page_detail->image)
                                                <div class="mb-5">
                                                    @if ($page_detail->bigimage)
                                                        <a class="swiper-slide" href="/upload/news/{{ $page_detail->image }}" data-fancybox="gallery"
                                                           style="background-image:url(/upload/news/{{ $page_detail->image }})"><img src="/upload/news/{{ $page_detail->image }}"></a>
                                                    @else

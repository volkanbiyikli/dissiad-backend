                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <div class="card page-box">
                                    <div class="card-body">
                                        ...
                                        <div class="page__title">{{ $page_detail->name }}
                                            <div class="page__sub-title">Bülten No: {{ $page_detail->name_id }}</div>
                                        </div>
                                        <div class="page__content">
                                            @if ($page_detail->image)
                                                <div class="mb-5">
                                                    @if ($page_detail->bigimage)
                                                        <a class="swiper-slide" href="/upload/bulletins/{{ $page_detail->image }}" data-fancybox="gallery"
                                                           style="background-image:url(/upload/bulletins/{{ $page_detail->image }})"><img src="/upload/bulletins/{{ $page_detail->image }}"></a>
                                                    @else
